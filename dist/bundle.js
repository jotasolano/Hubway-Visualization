...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Arc = __webpack_require__(16);
	
	var _Arc2 = _interopRequireDefault(_Arc);
	
	var _Scales = __webpack_require__(17);
	
	var _Scales2 = _interopRequireDefault(_Scales);
	
	var _Stations = __webpack_require__(18);
	...
	var crossfilter = __webpack_require__(20); //CommonJS
	// ** ------- DEPENDENCIES ------- **
	var Awesomplete = __webpack_require__(19);
	...
	var graphics = (0, _Arc2.default)();
	var scales = (0, _Scales2.default)();
	
	// ** ------- DataLoader() ------- **
	var cf = void 0;
	var data = (0, _data2.default)().on('error', function (err) {
		console.log(err);
	}).on('loaded', function (data) {
		//anything below only happens after data has been loaded
		var alltrips = data.trip1.concat(data.trip2);
		var stationData = data.stations;
		var stationInputs = (0, _Stations2.default)(stationData).on('stationTrig', function (inputVal) {
...
/***/ function(module, exports) {
	...
	module.exports = "data:application/font-woff;base64,bW9kdWxlLmV4cG9ydHMgPSBfX3dlYnBhY2tfcHVibGljX3BhdGhfXyArICI0NDhjMzRhNTZkNjk5YzI5MTE3YWRjNjRjNDNhZmZlYi53b2ZmMiI7"
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports = module.exports = __webpack_require__(4)();
	// imports
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css?family=Roboto:300,400);", ""]);
	
	// module
	exports.push([module.id, "h1, h2, h3, h4, h5, h6, p{\n\tfont-family: 'Roboto', sans-serif;\n\tcolor: #f2f2f2;\n}\n\n\nbody{\n\tbackground-color: #2B3238;\n}\n\n.title-container{\n\tmargin-bottom: 40px;\n\tfont-weight: 300;\n}\n\ninput{\n\tbackground-color: #2B3238;\n\tborder-width: 0px 0px 1px 0px;\n\tborder-color: #979797;\n\tcolor: #f2f2f2;\n}\n\ninput:focus{\n\tbackground-color: #2B3238;\n\tborder-width: 0px 0px 1px 0px;\n\tborder-color: #D401F3;\n\toutline-color: transparent;\n  \toutline-style: none;\n}\n\n::-webkit-input-placeholder { /* Chrome/Opera/Safari */\n\tfont-family: 'Roboto', sans-serif;\n  \tcolor: #686868;\n}\n::-moz-placeholder { /* Firefox 19+ */\n  \tcolor: #686868;\n}\n:-ms-input-placeholder { /* IE 10+ */\n  \tcolor: #686868;\n}\n:-moz-placeholder { /* Firefox 18- */\n  \tcolor: #686868;\n}\n\n\n.input-label{\n\tcolor: #8F8F8F;\n\tmargin-top: 5px;\n}\n\n.graphics-container{\n\twidth: 100%;\n\theight: 1200px;\n\tposition: relative;\n}\n\n#scales {\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  top: 0;\n  left: 0;\n}\n\n#canvas {\n  position: absolute;\n  top: 0;\n  left: 0;\n}\n\n/*#canvas{\n\tborder-style: solid;\n\tborder-width: 2px;\n\tborder-color: purple;\n}\n\n#scales{\n\tborder-style: solid;\n\tborder-width: 2px;\n\tborder-color: green;\n}*/\n\n.axis{\n\tstroke: white;\n\topacity: 0.3;\n\tstroke-width: 1px;\n}\n\n.sm-axis{\n\tstroke: white;\n\topacity: 0.6;\n\tstroke-width: 2px;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function DataLoader() {
		var q = (0, _d.queue)();
		var dis = (0, _d.dispatch)('loaded', 'error');
		...
		function exports() {
			q.defer(_d.csv, '../data/201601-hubway-tripdata.csv', parseTrips).defer(_d.csv, '../data/201602-hubway-tripdata.csv', parseTrips).defer(_d.csv, '../data/2016_0429_Hubway_Stations.csv', parseStations).await(function (err, trip1, trip2, stations) {
				if (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Arc() {
		...
		function exports(selection) {
			...
			var radius = Math.min(canvas.width, canvas.height) / 2 - 30;
			...
			// ** ------- LAYOUT ------- **
			var scaleAngle = d3.scaleTime().domain([0, 24]).range([0, 2 * Math.PI]);
	
			var arcGenerator = d3.arc().innerRadius(function (d) {
				return baseRadius + d.lvl;
			}).outerRadius(function (d) {
				return baseRadius + d.lvl + 1;
			}).startAngle(function (d) {
				return scaleAngle(d.startTime);
			}).endAngle(function (d) {
				return scaleAngle(d.endTime);
			}).context(context);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Scales() {
		var W = void 0,
		    H = void 0,
		    M = { t: 20, r: 20, b: 20, l: 20 };
		var timeRange = d3.range(0, 12, 1);
	
		function exports(selection) {
	
			W = W || selection.node().clientWidth - M.l - M.r;
			H = H || selection.node().clientHeight - M.t - M.b;
			var radius = Math.min(W, H) / 2 - 150; //how far out do the axes go
	
			var svg = selection.selectAll('svg').data([0]);
	
			var svgEnter = svg.enter().append('svg') //ENTER
			.attr('width', W + M.l + M.r).attr('height', H + M.t + M.b);
	
			var plotEnter = svgEnter.append('g').attr('class', 'plot time-series').attr('transform', 'translate(' + M.l + ',' + M.t + ')');
			...
			selection.selectAll('.disc').data([0]).attr('transform', 'translate(' + W / 2 + "," + H / 2 + ') rotate(' + 0 + ')').attr('cx', 0).attr('cy', 0).attr('r', 60).style('fill', 'white').style('opacity', 0.4);
	
			svgEnter.select('.axis').selectAll("g").data(d3.range(0, 360, 30)).enter().append('g').attr('transform', 'translate(' + W / 2 + ',' + H / 2 + ')').append('line').attr('x1', 60).attr('x2', radius)
			// .style('stroke-width', 0.5)
			.attr("transform", function (d) {
				return "rotate(" + -d + ")";
			});
	
			svgEnter.select('.sm-axis').selectAll("g").data(d3.range(0, 360, 30)).enter().append('g').attr('transform', 'translate(' + W / 2 + ',' + H / 2 + ')').append('line').attr('x1', radius - 20).attr('x2', radius).attr("transform", function (d) {
				return "rotate(" + -d + ")";
			});
	
			svgEnter.select('.time-labels').selectAll('g').data(timeRange).enter().append('g').attr('transform', 'translate(' + W / 2 + ',' + H / 2 + ') rotate(' + -90 + ')').append('text').attr('x', radius).text(function (d, i) {
				return d;
			}).attr('fill', 'white').attr("transform", function (d) {
				return "rotate(" + 30 * d + ")";
			});
	
			// svgEnger.select('.time-labels').selectAll('g').data(d3.range(0, 360, 30))
		};
		return exports;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function StationsList(data) {
		var dis = (0, _d.dispatch)('stationTrig', 'end');
		var stationList = [];
		data.forEach(function (el) {
			stationList.push(el.name);
		});
		...
		function exports() {
			...
			var stAwesomplete = new Awesomplete(startInput);
			stAwesomplete.list = stationList;
	
			var endInput = document.getElementById('end-station-input');
			var edAwesomplete = new Awesomplete(endInput);
			edAwesomplete.list = stationList;
	
			startInput.addEventListener("awesomplete-selectcomplete", function (e) {
				var startStation = startInput.value;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(21).crossfilter;
